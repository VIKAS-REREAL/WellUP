        ...
        <div className="relative z-10">
          ...
          >
            ...
            {menuOpen && (
              ...
              >
                ...
                <button
                  ...
                  className="w-full flex items-center gap-2.5 px-3 py-2 rounded-xl text-xs text-zinc-300 hover:text-white hover:bg-white/[0.08] transition-colors text-left cursor-pointer"
                >
            ...
            <textarea
              ...
              rows={1}
              style={{ outline: "none", border: "none", boxShadow: "none", pointerEvents: "auto" }}
            />

            {/* ── Bottom Bar: '+' on left, circular arrow on right ── */}
            <div className="prompt-bottom-bar" style={{ pointerEvents: "auto" }}>
              {/* Plus button at bottom-left */}
              <button
                type="button"
                onClick={() => setMenuOpen(!menuOpen)}
                className="prompt-plus-btn cursor-pointer"
              ...
              <button
                ...
                className={`prompt-send-circle cursor-pointer ${hasContent ? "active" : ""}`}
